...
const utils_1 = __nccwpck_require__(1495);
/**
 * Commands
 *
 * Command Format:
...
const file_command_1 = __nccwpck_require__(3899);
const utils_1 = __nccwpck_require__(1495);
const os = __importStar(__nccwpck_require__(2037));
const path = __importStar(__nccwpck_require__(1017));
const oidc_utils_1 = __nccwpck_require__(6663);
/**
...
const http_client_1 = __nccwpck_require__(5885);
const auth_1 = __nccwpck_require__(8671);
const core_1 = __nccwpck_require__(2540);
class OidcClient {
...
const pm = __nccwpck_require__(3487);
let tunnel;
var HttpCodes;
(function (HttpCodes) {
...
class HttpClient {
    ...
    _getAgent(parsedUrl) {
        ...
        if (useProxy) {
            ...
            if (!tunnel) {
                tunnel = __nccwpck_require__(9462);
            }
            const agentOptions = {
...
var parse = __nccwpck_require__(9867);
var enoent = __nccwpck_require__(8374);
...
function spawnSync(command, args, options) {
    ...
    if (!cpSpawnSync) {
        try {
            cpSpawnSync = __nccwpck_require__(7694);  // eslint-disable-line global-require
        } catch (ex) {
            throw new Error(
...
var resolveCommand = __nccwpck_require__(8439);
...
var LRU = __nccwpck_require__(968);
var resolveCommand = __nccwpck_require__(8439);
var hasBrokenSpawn = __nccwpck_require__(7679);
...
var which = __nccwpck_require__(1903);
var LRU = __nccwpck_require__(968);
...
module.exports = __nccwpck_require__(6735)(exports);
...
function setup(env) {
  ...
  createDebug.humanize = __nccwpck_require__(8846);
...
if (typeof process === 'undefined' || process.type === 'renderer' || process.browser === true || process.__nwjs) {
  ...
  module.exports = __nccwpck_require__(8692);
}
...
try {
  ...
  var supportsColor = __nccwpck_require__(335);
...
__nccwpck_require__(4182)(gm.prototype);
__nccwpck_require__(945)(gm);
__nccwpck_require__(5494)(gm.prototype);
__nccwpck_require__(8058)(gm.prototype);
__nccwpck_require__(766)(gm.prototype);
__nccwpck_require__(1635)(gm.prototype);
__nccwpck_require__(3363)(gm.prototype);
__nccwpck_require__(2802)(gm.prototype);
__nccwpck_require__(5348)(gm.prototype);
...
module.exports.utils = __nccwpck_require__(8942);
module.exports.compare = __nccwpck_require__(3363)();
...
var argsToArray = (__nccwpck_require__(8942).argsToArray);
var isUtil = (__nccwpck_require__(8942).isUtil);
/**
 * Extend proto
 */
...
var spawn = __nccwpck_require__(7438);
var utils = __nccwpck_require__(8942);
var debug = __nccwpck_require__(6952)('gm');
var series = __nccwpck_require__(2262);
...
module.exports = function (proto) {
  __nccwpck_require__(8357)(proto);
  __nccwpck_require__(8734)(proto);
  __nccwpck_require__(4374)(proto);
  __nccwpck_require__(9037)(proto);
}
...
var fs = __nccwpck_require__(7147);
var parallel = __nccwpck_require__(2199);
...
var escape = (__nccwpck_require__(8942).escape);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(3801)
} else {
  core = __nccwpck_require__(3354)
}
...
var Map = __nccwpck_require__(7869)
var util = __nccwpck_require__(3837)

// A linked list to keep track of recently-used-ness
var Yallist = __nccwpck_require__(8311)
...
let gm = __nccwpck_require__(1520)
...
if (typeof Map === 'function' && !process.env.TEST_PSEUDOMAP) {
  ...
  module.exports = __nccwpck_require__(3817)
}
...
var path = __nccwpck_require__(1017)
var COLON = isWindows ? ';' : ':'
var isexe = __nccwpck_require__(204)
...
const hasFlag = __nccwpck_require__(3836);
...
(() => {
const core = __nccwpck_require__(2540);
